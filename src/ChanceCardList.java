...
public class ChanceCardList {
	...
	private ChanceCard c1 = new ChanceCard("Du modtager dit aktieudbytte 1000 kr.", 1000, 0);
	...
	private ChanceCard c5 = new ChanceCard("Du har haft for mange cigaretter med hjem. Betal 200 kr. i told-bøde", -200, 0);
	private ChanceCard c6 = new ChanceCard("Du har modtaget din tandlægeregning. Betal 2000 kr.", -2000, 0);
	private ChanceCard c7 = new ChanceCard("Du har haft 12 rigtige i tips 13. Modtag 1000 kr.", 1000, 0);
	private ChanceCard c8 = new ChanceCard("Din restskat er gået ind. Modtag 1000 kr.", 1000, 0);
	private ChanceCard c9 = new ChanceCard("Du har solgt din gamle velo. Modtag 1000 kr.", 1000, 0);
	// Skal have funktion med, så det er alle der betaler til fødselaren
	private ChanceCard c10 = new ChanceCard("Det er din fødselsdag. Modtag 200 kr. fra hver medspiller.", 200);
	private ChanceCard c11 = new ChanceCard("Du har fundet en pung på gaden. Stjæl de 200 kr der ligger i den.", 200, 0);
	private ChanceCard c12 = new ChanceCard("Du har modtaget din vægtafgift. Betal 1000 kr.", -1000, 0);
